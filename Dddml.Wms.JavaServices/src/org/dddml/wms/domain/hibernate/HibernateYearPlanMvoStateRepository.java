...
public class HibernateYearPlanMvoStateRepository implements YearPlanMvoStateRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(AbstractYearPlanMvoState.SimpleYearPlanMvoState.class);
    ...
    public void save(YearPlanMvoState state)
    {
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(YearPlanMvoState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<YearPlanMvoState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(YearPlanMvoState.class);
    ...
    @Transactional(readOnly = true)
    public YearPlanMvoState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<YearPlanMvoState> list = (List<YearPlanMvoState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public YearPlanMvoState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
