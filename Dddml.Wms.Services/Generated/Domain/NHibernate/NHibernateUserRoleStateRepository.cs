...
namespace Dddml.Wms.Domain.NHibernate
{
	...
	public partial class NHibernateUserRoleStateRepository : IUserRoleStateRepository
	{
		...
		public NHibernateUserRoleStateRepository ()
		{
		}
        ...
        public IEnumerable<IUserRoleState> GetAll(int firstResult, int maxResults)
        {
            ...
            return criteria.List<UserRoleState>();
        }
        ...
        [Transaction(ReadOnly = true)]
        public virtual IEnumerable<IUserRoleState> Get(Dddml.Support.Criterion.ICriterion filter, IList<string> orders = null, int firstResult = 0, int maxResults = int.MaxValue)
        {
            var criteria = CurrentSession.CreateCriteria<UserRoleState>();
        ...
        [Transaction(ReadOnly = true)]
        public virtual IUserRoleState GetFirst(IEnumerable<KeyValuePair<string, object>> filter, IList<string> orders = null)
        {
            var list = (IList<UserRoleState>)Get(filter, orders, 0, 1);
        ...
        [Transaction(ReadOnly = true)]
        public virtual IUserRoleState GetFirst(KeyValuePair<string, object> keyValue, IList<string> orders = null)
        {
