...
public class DayPlanMvoStateEventDto extends AbstractStateEvent
{
	...
	public static class DayPlanMvoStateCreatedDto extends DayPlanMvoStateEventDto
	{
        @Override
        public String getStateEventType()
        {
	...
	public static class DayPlanMvoStateMergePatchedDto extends DayPlanMvoStateEventDto
	{
        @Override
        public String getStateEventType()
        {
	...
	public class DayPlanMvoStateDeletedDto extends DayPlanMvoStateEventDto
	{
        @Override
        public String getStateEventType()
        {
