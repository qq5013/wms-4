...
namespace Dddml.Wms.HttpServices.ApiControllers
{
    ...
    [RoutePrefix("api/UserRoleMvos")][Authorize]
    public partial class UserRoleMvosController : ApiController
    {

        IUserRoleMvoApplicationService _userRoleMvoApplicationService = ApplicationContext.Current["UserRoleMvoApplicationService"] as IUserRoleMvoApplicationService;
        ...
        public IEnumerable<UserRoleMvoStateDto> GetAll(string sort = null, string fields = null, int firstResult = 0, int maxResults = int.MaxValue, string filter = null)
        {
          try {
            ...
            {
                states = _userRoleMvoApplicationService.Get(CriterionDto.ToSubclass(JObject.Parse(filter).ToObject<CriterionDto>(),new ApiControllerTypeConverter(), new PropertyTypeResolver())
        ...
        public long GetCount(string filter = null)
        {
          try
          {
            ...
            if (!String.IsNullOrWhiteSpace(filter))
            {
                count = _userRoleMvoApplicationService.GetCount(CriterionDto.ToSubclass(JObject.Parse(filter).ToObject<CriterionDto>(),new ApiControllerTypeConverter(), new PropertyTypeResolver()));
            }
            else 
            {
                count = _userRoleMvoApplicationService.GetCount(UserRoleMvosControllerUtils.GetQueryFilterDictionary(this.Request.GetQueryNameValuePairs()));
            }
            return count;
          } catch (Exception ex) { var response = UserRoleMvosControllerUtils.GetErrorHttpResponseMessage(ex); throw new HttpResponseException(response); }
        }
        ...
        [HttpPatch]
        public void Patch(string id, [FromBody]MergePatchUserRoleMvoDto value)
        {
          try {
            UserRoleMvosControllerUtils.SetNullIdOrThrowOnInconsistentIds(id, value);
            _userRoleMvoApplicationService.When(value as IMergePatchUserRoleMvo);
          } catch (Exception ex) { var response = UserRoleMvosControllerUtils.GetErrorHttpResponseMessage(ex); throw new HttpResponseException(response); }
        }
        ...
        {
          try {
            var value = new DeleteUserRoleMvoDto();
            value.CommandId = commandId;
            value.RequesterId = requesterId;
            UserRoleMvosControllerUtils.SetNullIdOrThrowOnInconsistentIds(id, value);
            _userRoleMvoApplicationService.When(value as IDeleteUserRoleMvo);
          } catch (Exception ex) { var response = UserRoleMvosControllerUtils.GetErrorHttpResponseMessage(ex); throw new HttpResponseException(response); }
        }
        ...
        public IEnumerable<PropertyMetadata> GetMetadataFilteringFields()
        {
          try {
            ...
            foreach (var p in UserRoleMvoMetadata.Instance.Properties)
            {
        ...
        [HttpGet]
        public IUserRoleMvoStateEvent GetStateEvent(string id, long version)
        {
          try {
            var idObj = UserRoleMvosControllerUtils.ParseIdString(id);
            return _userRoleMvoApplicationService.GetStateEvent(idObj, version);
          } catch (Exception ex) { var response = UserRoleMvosControllerUtils.GetErrorHttpResponseMessage(ex); throw new HttpResponseException(response); }
        }
        ...
        private class PropertyTypeResolver : IPropertyTypeResolver
        {
            ...
            {
                return UserRoleMvosControllerUtils.GetFilterPropertyType(propertyName);
            }
        }
    ...
    public static class UserRoleMvosControllerUtils
    {
        ...
        public static void SetNullIdOrThrowOnInconsistentIds(string id, CreateOrMergePatchOrDeleteUserRoleMvoDto value)
        {
            var idObj = ParseIdString(id.IsNormalized() ? id : id.Normalize());
            if (value.UserRoleId == null)
            {
                value.UserRoleId = new UserRoleIdDto(idObj);
            }
            else if (!((ICreateOrMergePatchOrDeleteUserRoleMvo)value).UserRoleId.Equals(idObj))
            {
                throw DomainError.Named("inconsistentId", "Argument Id {0} NOT equals body Id {1}", id, value.UserRoleId);
            }
        }
        ...
        public static string GetFilterPropertyName(string fieldName)
        {
            ...
            if (UserRoleMvoMetadata.Instance.PropertyMetadataDictionary.ContainsKey(fieldName))
            {
        ...
        {
            if (UserRoleMvoMetadata.Instance.PropertyMetadataDictionary.ContainsKey(propertyName))
            {
                return UserRoleMvoMetadata.Instance.PropertyMetadataDictionary[propertyName].Type;
            }
        ...
        public static IEnumerable<UserRoleMvoStateDto> ToUserRoleMvoStateDtoCollection(IEnumerable<UserRoleId> ids)
        {
            ...
            foreach (var id in ids)
            {
                ...
                dto.UserRoleId = new UserRoleIdDto(id);
                states.Add(dto);
            }
            return states;
        }
