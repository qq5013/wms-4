...
namespace Dddml.Wms.Domain
{
    ...
    public partial interface IAttributeSetInstanceApplicationServiceFactory
    {

        IAttributeSetInstanceApplicationService AttributeSetInstanceApplicationService { get; }
