...
public abstract class AbstractMonthPlanMvoCommand extends AbstractCommand implements MonthPlanMvoCommand
{
    ...
    public static abstract class AbstractCreateOrMergePatchMonthPlanMvo extends AbstractMonthPlanMvoCommand implements CreateOrMergePatchMonthPlanMvo
    {
    ...
    public static abstract class AbstractCreateMonthPlanMvo extends AbstractCreateOrMergePatchMonthPlanMvo implements CreateMonthPlanMvo
    {
        @Override
    ...
    public static abstract class AbstractMergePatchMonthPlanMvo extends AbstractCreateOrMergePatchMonthPlanMvo implements MergePatchMonthPlanMvo
    {
        @Override
        public String getCommandType() {
    ...
    public static class SimpleCreateMonthPlanMvo extends AbstractCreateMonthPlanMvo
    {
    }

    public static class SimpleMergePatchMonthPlanMvo extends AbstractMergePatchMonthPlanMvo
    {
    }

	public static class SimpleDeleteMonthPlanMvo extends AbstractMonthPlanMvoCommand implements DeleteMonthPlanMvo
	{
        @Override
        public String getCommandType() {
