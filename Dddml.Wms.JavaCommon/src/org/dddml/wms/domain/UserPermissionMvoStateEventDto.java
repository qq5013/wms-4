...
public class UserPermissionMvoStateEventDto extends AbstractStateEvent
{
	...
	public static class UserPermissionMvoStateCreatedDto extends UserPermissionMvoStateEventDto
	{
        @Override
        public String getStateEventType()
        {
	...
	public static class UserPermissionMvoStateMergePatchedDto extends UserPermissionMvoStateEventDto
	{
        @Override
        public String getStateEventType()
        {
	...
	public class UserPermissionMvoStateDeletedDto extends UserPermissionMvoStateEventDto
	{
        @Override
        public String getStateEventType()
        {
