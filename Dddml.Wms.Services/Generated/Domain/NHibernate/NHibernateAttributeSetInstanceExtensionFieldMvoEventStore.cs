...
namespace Dddml.Wms.Domain.NHibernate
{
	...
	public class NHibernateAttributeSetInstanceExtensionFieldMvoEventStore : NHibernateEventStoreBase
	{
		...
		{
			return new AttributeSetInstanceExtensionFieldMvoStateEventId((AttributeSetInstanceExtensionFieldId)(eventStoreAaggregateId as EventStoreAggregateId).Id, (long)version);
		}
