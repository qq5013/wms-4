...
namespace Dddml.Wms.Domain
{
	...
	public class TeamStateEventIdFlattenedDto : IIdFlattenedDto
	{

        private static string[] _flattenedPropertyNames = new string[] { "TeamName", "Version" };
        ...
        {
            if (fieldName.Equals("TeamName", StringComparison.InvariantCultureIgnoreCase))
            {
		...
		public TeamStateEventIdFlattenedDto(TeamStateEventId val)
		{
			this._value = val;
		}
		...
		public override bool Equals (object obj)
		{
			...
			TeamStateEventIdFlattenedDto other = obj as TeamStateEventIdFlattenedDto;
			if (other == null) {
				return false;
			}
