...
public abstract class AbstractUserClaimMvoStateEvent extends AbstractStateEvent implements UserClaimMvoStateEvent 
{
    private UserClaimMvoStateEventId stateEventId;

    public UserClaimMvoStateEventId getStateEventId() {
        return this.stateEventId;
    }

    public void setStateEventId(UserClaimMvoStateEventId stateEventId) {
    ...
    protected AbstractUserClaimMvoStateEvent(UserClaimMvoStateEventId stateEventId) {
        this.stateEventId = stateEventId;
    }
    ...
    public static abstract class AbstractUserClaimMvoStateCreated extends AbstractUserClaimMvoStateEvent implements UserClaimMvoStateCreated
    {
        public AbstractUserClaimMvoStateCreated() {
        }

        public AbstractUserClaimMvoStateCreated(UserClaimMvoStateEventId stateEventId) {
            super(stateEventId);
        }
    ...
    public static abstract class AbstractUserClaimMvoStateMergePatched extends AbstractUserClaimMvoStateEvent implements UserClaimMvoStateMergePatched
    {
        public AbstractUserClaimMvoStateMergePatched() {
        }

        public AbstractUserClaimMvoStateMergePatched(UserClaimMvoStateEventId stateEventId) {
            super(stateEventId);
        }
    ...
    public static abstract class AbstractUserClaimMvoStateDeleted extends AbstractUserClaimMvoStateEvent implements UserClaimMvoStateDeleted
    {
        public AbstractUserClaimMvoStateDeleted() {
        }

        public AbstractUserClaimMvoStateDeleted(UserClaimMvoStateEventId stateEventId) {
            super(stateEventId);
        }
