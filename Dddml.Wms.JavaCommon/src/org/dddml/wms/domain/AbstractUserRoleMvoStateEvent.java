...
public abstract class AbstractUserRoleMvoStateEvent extends AbstractStateEvent implements UserRoleMvoStateEvent 
{
    private UserRoleMvoStateEventId stateEventId;

    public UserRoleMvoStateEventId getStateEventId() {
        return this.stateEventId;
    }

    public void setStateEventId(UserRoleMvoStateEventId stateEventId) {
    ...
    protected AbstractUserRoleMvoStateEvent() {
    }

    protected AbstractUserRoleMvoStateEvent(UserRoleMvoStateEventId stateEventId) {
        this.stateEventId = stateEventId;
    }
    ...
    public static abstract class AbstractUserRoleMvoStateCreated extends AbstractUserRoleMvoStateEvent implements UserRoleMvoStateCreated
    {
        public AbstractUserRoleMvoStateCreated() {
        }

        public AbstractUserRoleMvoStateCreated(UserRoleMvoStateEventId stateEventId) {
            super(stateEventId);
        }
    ...
    public static abstract class AbstractUserRoleMvoStateMergePatched extends AbstractUserRoleMvoStateEvent implements UserRoleMvoStateMergePatched
    {
        public AbstractUserRoleMvoStateMergePatched() {
        }

        public AbstractUserRoleMvoStateMergePatched(UserRoleMvoStateEventId stateEventId) {
            super(stateEventId);
        }
    ...
    public static abstract class AbstractUserRoleMvoStateDeleted extends AbstractUserRoleMvoStateEvent implements UserRoleMvoStateDeleted
    {
        public AbstractUserRoleMvoStateDeleted() {
        }

        public AbstractUserRoleMvoStateDeleted(UserRoleMvoStateEventId stateEventId) {
            super(stateEventId);
        }
