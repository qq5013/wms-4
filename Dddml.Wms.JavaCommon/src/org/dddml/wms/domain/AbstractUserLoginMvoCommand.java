...
public abstract class AbstractUserLoginMvoCommand extends AbstractCommand implements UserLoginMvoCommand
{
    ...
    public static abstract class AbstractCreateOrMergePatchUserLoginMvo extends AbstractUserLoginMvoCommand implements CreateOrMergePatchUserLoginMvo
    {
    ...
    public static abstract class AbstractCreateUserLoginMvo extends AbstractCreateOrMergePatchUserLoginMvo implements CreateUserLoginMvo
    {
        @Override
    ...
    public static abstract class AbstractMergePatchUserLoginMvo extends AbstractCreateOrMergePatchUserLoginMvo implements MergePatchUserLoginMvo
    {
        @Override
        public String getCommandType() {
    ...
    public static class SimpleCreateUserLoginMvo extends AbstractCreateUserLoginMvo
    {
    }

    public static class SimpleMergePatchUserLoginMvo extends AbstractMergePatchUserLoginMvo
    {
    }

	public static class SimpleDeleteUserLoginMvo extends AbstractUserLoginMvoCommand implements DeleteUserLoginMvo
	{
        @Override
        public String getCommandType() {
