...
{
	public interface IUserPermissionMvoStateEvent : IEvent, IStateEventDto, IGlobalIdentity<UserPermissionMvoStateEventId>, ICreated<string>
	{
		UserPermissionMvoStateEventId StateEventId { get; }
