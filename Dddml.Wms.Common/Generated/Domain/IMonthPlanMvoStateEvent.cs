...
{
	public interface IMonthPlanMvoStateEvent : IEvent, IStateEventDto, IGlobalIdentity<MonthPlanMvoStateEventId>, ICreated<string>
	{
		MonthPlanMvoStateEventId StateEventId { get; }
	...
	public interface IMonthPlanMvoStateCreated : IMonthPlanMvoStateEvent//, IMonthPlanMvoStateProperties
	{
	
	}


	public interface IMonthPlanMvoStateMergePatched : IMonthPlanMvoStateEvent//, IMonthPlanMvoStateProperties
	{
	...
	public interface IMonthPlanMvoStateDeleted : IMonthPlanMvoStateEvent
	{
	}
