...
namespace Dddml.Wms.Domain.NHibernate
{
	...
	public class NHibernateUserRoleEventStore : NHibernateEventStoreBase
	{
		public override object GetEventId(IEventStoreAggregateId eventStoreAaggregateId, long version)
		{
			return new UserRoleStateEventId((UserRoleId)(eventStoreAaggregateId as EventStoreAggregateId).Id, (long)version);
		}

		public override Type GetSupportedStateEventType()
		{
			return typeof(UserRoleStateEventBase);
		}
	}
