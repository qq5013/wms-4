...
namespace Dddml.Wms.Domain.NHibernate
{
	...
	public partial class NHibernateUserPermissionStateRepository : IUserPermissionStateRepository
	{
		...
		public NHibernateUserPermissionStateRepository ()
		{
		}
		...
		public IUserPermissionState Get (UserPermissionId id)
		{
			...
			if (state == null) {
				...
				(state as UserPermissionState).Id = id;
			}
			return state;
		}
        ...
        public IEnumerable<IUserPermissionState> GetAll(int firstResult, int maxResults)
        {
            ...
            return criteria.List<UserPermissionState>();
        }
        ...
        [Transaction(ReadOnly = true)]
        public virtual IEnumerable<IUserPermissionState> Get(Dddml.Support.Criterion.ICriterion filter, IList<string> orders = null, int firstResult = 0, int maxResults = int.MaxValue)
        {
            var criteria = CurrentSession.CreateCriteria<UserPermissionState>();
        ...
        [Transaction(ReadOnly = true)]
        public virtual IUserPermissionState GetFirst(IEnumerable<KeyValuePair<string, object>> filter, IList<string> orders = null)
        {
            var list = (IList<UserPermissionState>)Get(filter, orders, 0, 1);
        ...
        [Transaction(ReadOnly = true)]
        public virtual IUserPermissionState GetFirst(KeyValuePair<string, object> keyValue, IList<string> orders = null)
        {
