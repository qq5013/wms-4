...
namespace Dddml.Wms.HttpServices.ApiControllers
{
    ...
    [RoutePrefix("api/Permissions")][Authorize]
    public partial class PermissionsController : ApiController
    {

        IPermissionApplicationService _permissionApplicationService = ApplicationContext.Current["PermissionApplicationService"] as IPermissionApplicationService;
    ...
    public static class PermissionsControllerUtils
    {
        ...
        public static void SetNullIdOrThrowOnInconsistentIds(string id, CreateOrMergePatchOrDeletePermissionDto value)
        {
            var idObj = id;
            if (value.PermissionId == null)
            {
                value.PermissionId = idObj;
            }
            else if (!((ICreateOrMergePatchOrDeletePermission)value).PermissionId.Equals(idObj))
            {
                throw DomainError.Named("inconsistentId", "Argument Id {0} NOT equals body Id {1}", id, value.PermissionId);
            }
        }
        ...
        public static string GetFilterPropertyName(string fieldName)
        {
            ...
            if (PermissionMetadata.Instance.PropertyMetadataDictionary.ContainsKey(fieldName))
            {
        ...
        {
            if (PermissionMetadata.Instance.PropertyMetadataDictionary.ContainsKey(propertyName))
            {
                return PermissionMetadata.Instance.PropertyMetadataDictionary[propertyName].Type;
            }
