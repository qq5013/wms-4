...
namespace Dddml.Wms.Domain
{
	...
	public abstract class UserClaimCommandDtoBase : ICommandDto, ICreateUserClaim, IMergePatchUserClaim, IRemoveUserClaim
	{
        ...
        // //////////////////////////////////////////////
/*
        private IUserClaimCommand _innerCommand;
        ...
        private RemoveUserClaim ToRemoveUserClaim()
        {
            var cmd = new RemoveUserClaim();
            cmd.CommandId = this.CommandId;
            cmd.RequesterId = this.RequesterId;

            cmd.ClaimId = ((ICreateOrMergePatchOrRemoveUserClaim)this).ClaimId;
            return cmd;
        }

        internal MergePatchUserClaim ToMergePatchUserClaim()
        {
            ...
            cmd.ClaimId = ((ICreateOrMergePatchOrRemoveUserClaim)this).ClaimId;
            cmd.ClaimType = ((ICreateOrMergePatchOrRemoveUserClaim)this).ClaimType;
            cmd.ClaimValue = ((ICreateOrMergePatchOrRemoveUserClaim)this).ClaimValue;
            cmd.Active = ((ICreateOrMergePatchOrRemoveUserClaim)this).Active;
            cmd.UserId = ((ICreateOrMergePatchOrRemoveUserClaim)this).UserId;
            
            cmd.IsPropertyClaimTypeRemoved = (this as IMergePatchUserClaim).IsPropertyClaimTypeRemoved;
            cmd.IsPropertyClaimValueRemoved = (this as IMergePatchUserClaim).IsPropertyClaimValueRemoved;
            cmd.IsPropertyActiveRemoved = (this as IMergePatchUserClaim).IsPropertyActiveRemoved;
            return cmd;
        }

        internal CreateUserClaim ToCreateUserClaim()
        {
