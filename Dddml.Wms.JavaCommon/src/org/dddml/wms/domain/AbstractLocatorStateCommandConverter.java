...
public abstract class AbstractLocatorStateCommandConverter<TCreateLocator extends LocatorCommand.CreateLocator, TMergePatchLocator extends LocatorCommand.MergePatchLocator, TDeleteLocator extends LocatorCommand.DeleteLocator>
{
    ...
    public static class SimpleLocatorStateCommandConverter extends AbstractLocatorStateCommandConverter<AbstractLocatorCommand.SimpleCreateLocator, AbstractLocatorCommand.SimpleMergePatchLocator, AbstractLocatorCommand.SimpleDeleteLocator>
    {
        @Override
        protected AbstractLocatorCommand.SimpleCreateLocator newCreateLocator() {
            return new AbstractLocatorCommand.SimpleCreateLocator();
        }

        @Override
        protected AbstractLocatorCommand.SimpleMergePatchLocator newMergePatchLocator() {
            return new AbstractLocatorCommand.SimpleMergePatchLocator();
        }

        @Override
        protected AbstractLocatorCommand.SimpleDeleteLocator newDeleteLocator() {
            return new AbstractLocatorCommand.SimpleDeleteLocator();
        }
