...
namespace Dddml.Wms.Domain
{
	...
	public class MonthPlanStateEventId
	{
		...
		internal MonthPlanStateEventId ()
		{
		}

		public MonthPlanStateEventId (PersonalName personalName, int year, int month, long personVersion)
		{
		...
		public override bool Equals (object obj)
		{
			...
			MonthPlanStateEventId other = obj as MonthPlanStateEventId;
			if (other == null) {
				return false;
			}
