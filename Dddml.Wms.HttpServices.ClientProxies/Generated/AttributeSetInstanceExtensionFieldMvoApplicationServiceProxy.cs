...
namespace Dddml.Wms.HttpServices.ClientProxies
{
    ...
    public partial class AttributeSetInstanceExtensionFieldMvoApplicationServiceProxy : IAttributeSetInstanceExtensionFieldMvoApplicationService
    {
        ...
        {
            var idObj = ToIdString((c as ICreateAttributeSetInstanceExtensionFieldMvo).AttributeSetInstanceExtensionFieldId);
        ...
        {
            var idObj = ToIdString((c as IMergePatchAttributeSetInstanceExtensionFieldMvo).AttributeSetInstanceExtensionFieldId);
            var uriParameters = new AttributeSetInstanceExtensionFieldMvoUriParameters();
            uriParameters.Id = idObj;
        ...
        public void When(DeleteAttributeSetInstanceExtensionFieldMvoDto c)
        {
            //Action act = async () =>
            //{
            var idObj = ToIdString((c as IDeleteAttributeSetInstanceExtensionFieldMvo).AttributeSetInstanceExtensionFieldId);
            var uriParameters = new AttributeSetInstanceExtensionFieldMvoUriParameters();
            uriParameters.Id = idObj;
        ...
        public IAttributeSetInstanceExtensionFieldMvoState Get(AttributeSetInstanceExtensionFieldId attributeSetInstanceExtensionFieldId)
        {
            ...
            var idObj = ToIdString(attributeSetInstanceExtensionFieldId);
            var uriParameters = new AttributeSetInstanceExtensionFieldMvoUriParameters();
            uriParameters.Id = idObj;
        ...
        public IEnumerable<IAttributeSetInstanceExtensionFieldMvoState> Get(IEnumerable<KeyValuePair<string, object>> filter, IList<string> orders = null, int firstResult = 0, int maxResults = int.MaxValue, IList<string> fields = null)
        {
			...
			var q = new AttributeSetInstanceExtensionFieldMvoesGetQuery();
            ...
            var req = new AttributeSetInstanceExtensionFieldMvoesGetRequest();
            req.Query = q;
            var resp = _ramlClient.AttributeSetInstanceExtensionFieldMvoes.Get(req).GetAwaiter().GetResult();
            ThrowOnHttpResponseError(resp);
            states = resp.Content;
            return states;
        }
		...
		{
			var q = new AttributeSetInstanceExtensionFieldMvoesCountGetQuery();
            q.FilterTag = GetFilterTagQueryValueString(filter);
            var req = new AttributeSetInstanceExtensionFieldMvoesCountGetRequest();
            req.Query = q;
            var resp = _ramlClient.AttributeSetInstanceExtensionFieldMvoesCount.Get(req).GetAwaiter().GetResult();
            ThrowOnHttpResponseError(resp);
        ...
        protected static string ToIdString(AttributeSetInstanceExtensionFieldId id)
        {
    ...
    public partial class AttributeSetInstanceExtensionFieldMvoApplicationServiceProxyFactory : IAttributeSetInstanceExtensionFieldMvoApplicationServiceFactory
    {

        private string _endpointUrl;

        public AttributeSetInstanceExtensionFieldMvoApplicationServiceProxyFactory(string endpointUrl)
        {
        ...
        public IAttributeSetInstanceExtensionFieldMvoApplicationService AttributeSetInstanceExtensionFieldMvoApplicationService
        {
            get
            {
                return new AttributeSetInstanceExtensionFieldMvoApplicationServiceProxy(_endpointUrl);
            }
        }
