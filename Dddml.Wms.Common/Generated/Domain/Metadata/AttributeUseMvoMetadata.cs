...
namespace Dddml.Wms.Domain.Metadata
{
    ...
    public class AttributeUseMvoMetadata
    {
        private static PropertyMetadata[] _properties = new PropertyMetadata[]{
                new PropertyMetadata {
                    ...
                    DeclairingObjectName = "AttributeUseMvo",
                    DisplayName = "",
                    Description = "",
                    Length = 0,
                    GenericTypeName = "",
        ...
        static AttributeUseMvoMetadata()
        {
        ...
        private static AttributeUseMvoMetadata _instance = new AttributeUseMvoMetadata();

        public static AttributeUseMvoMetadata Instance
        {
            get
            {
                return _instance;
        ...
        protected AttributeUseMvoMetadata()
        { 
        }
