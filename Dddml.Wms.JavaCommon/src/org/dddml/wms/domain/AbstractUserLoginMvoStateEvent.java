...
public abstract class AbstractUserLoginMvoStateEvent extends AbstractStateEvent implements UserLoginMvoStateEvent 
{
    ...
    {
        public AbstractUserLoginMvoStateMergePatched() {
        }

        public AbstractUserLoginMvoStateMergePatched(UserLoginMvoStateEventId stateEventId) {
            super(stateEventId);
        }
