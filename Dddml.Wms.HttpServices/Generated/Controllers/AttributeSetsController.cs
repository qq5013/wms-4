    ...
    public partial class AttributeSetsController : ApiController
    {
        ...
        public IEnumerable<AttributeSetStateDto> GetAll(string sort = null, string fields = null, int firstResult = 0, int maxResults = int.MaxValue, string filter = null)
        {
          try {
            ...
            {
                states = _attributeSetApplicationService.Get(GetQueryFilterDictionary(this.Request.GetQueryNameValuePairs())
                    , GetQueryOrders(sort), firstResult, maxResults);
            }
        ...
        public long GetCount(string filter = null)
        {
          try
          {
            ...
            {
                count = _attributeSetApplicationService.GetCount(GetQueryFilterDictionary(this.Request.GetQueryNameValuePairs()));
            }
            return count;
          } catch (Exception ex) { var response = GetErrorHttpResponseMessage(ex); throw new HttpResponseException(response); }
        }
