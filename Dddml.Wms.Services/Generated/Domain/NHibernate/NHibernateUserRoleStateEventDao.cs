...
namespace Dddml.Wms.Domain.NHibernate
{
	...
	public class NHibernateUserRoleStateEventDao : IUserRoleStateEventDao
	{
		...
		public NHibernateUserRoleStateEventDao ()
		{
		}

		public void Save(IUserRoleStateEvent stateEvent)
		{
        ...
        public IEnumerable<IUserRoleStateEvent> FindByUserStateEventId(UserStateEventId userStateEventId)
        {
            var criteria = CurrentSession.CreateCriteria<UserRoleStateEventBase>();
            ...
            return criteria.Add(partIdCondition).List<UserRoleStateEventBase>();
        }
