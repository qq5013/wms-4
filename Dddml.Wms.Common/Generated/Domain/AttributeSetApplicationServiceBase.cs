...
namespace Dddml.Wms.Domain
{
	...
	public abstract partial class AttributeSetApplicationServiceBase : IAttributeSetApplicationService, IApplicationService
	{
        ...
        public virtual IEnumerable<IAttributeSetState> Get(IDictionary<string, object> filter, IList<string> orders = null, int firstResult = 0, int maxResults = int.MaxValue)
		{
