...
namespace Dddml.Wms.Domain.Metadata
{
    ...
    public class UserLoginMvoMetadata
    {
        private static PropertyMetadata[] _properties = new PropertyMetadata[]{
                new PropertyMetadata {
                    ...
                    DeclairingObjectName = "UserLoginMvo",
                    DisplayName = "",
                    Description = "",
                    Length = 0,
                    GenericTypeName = "",
        ...
        private static UserLoginMvoMetadata _instance = new UserLoginMvoMetadata();

        public static UserLoginMvoMetadata Instance
        {
            get
            {
                return _instance;
        ...
        protected UserLoginMvoMetadata()
        { 
        }
