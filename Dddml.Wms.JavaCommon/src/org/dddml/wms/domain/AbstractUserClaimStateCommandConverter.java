...
public abstract class AbstractUserClaimStateCommandConverter<TCreateUserClaim extends UserClaimCommand.CreateUserClaim, TMergePatchUserClaim extends UserClaimCommand.MergePatchUserClaim, TRemoveUserClaim extends UserClaimCommand.RemoveUserClaim>
{
    ...
    public static class SimpleUserClaimStateCommandConverter extends AbstractUserClaimStateCommandConverter<AbstractUserClaimCommand.SimpleCreateUserClaim, AbstractUserClaimCommand.SimpleMergePatchUserClaim, AbstractUserClaimCommand.SimpleRemoveUserClaim>
    {
        @Override
        protected AbstractUserClaimCommand.SimpleCreateUserClaim newCreateUserClaim() {
            return new AbstractUserClaimCommand.SimpleCreateUserClaim();
        }

        @Override
        protected AbstractUserClaimCommand.SimpleMergePatchUserClaim newMergePatchUserClaim() {
            return new AbstractUserClaimCommand.SimpleMergePatchUserClaim();
        }

        @Override
        protected AbstractUserClaimCommand.SimpleRemoveUserClaim newRemoveUserClaim() {
            return new AbstractUserClaimCommand.SimpleRemoveUserClaim();
        }
