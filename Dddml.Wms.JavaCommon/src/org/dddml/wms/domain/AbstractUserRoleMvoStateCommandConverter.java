...
public abstract class AbstractUserRoleMvoStateCommandConverter<TCreateUserRoleMvo extends UserRoleMvoCommand.CreateUserRoleMvo, TMergePatchUserRoleMvo extends UserRoleMvoCommand.MergePatchUserRoleMvo, TDeleteUserRoleMvo extends UserRoleMvoCommand.DeleteUserRoleMvo>
{
    ...
    public static class SimpleUserRoleMvoStateCommandConverter extends AbstractUserRoleMvoStateCommandConverter<AbstractUserRoleMvoCommand.SimpleCreateUserRoleMvo, AbstractUserRoleMvoCommand.SimpleMergePatchUserRoleMvo, AbstractUserRoleMvoCommand.SimpleDeleteUserRoleMvo>
    {
        @Override
        protected AbstractUserRoleMvoCommand.SimpleCreateUserRoleMvo newCreateUserRoleMvo() {
            return new AbstractUserRoleMvoCommand.SimpleCreateUserRoleMvo();
        }

        @Override
        protected AbstractUserRoleMvoCommand.SimpleMergePatchUserRoleMvo newMergePatchUserRoleMvo() {
            return new AbstractUserRoleMvoCommand.SimpleMergePatchUserRoleMvo();
        }

        @Override
        protected AbstractUserRoleMvoCommand.SimpleDeleteUserRoleMvo newDeleteUserRoleMvo() {
            return new AbstractUserRoleMvoCommand.SimpleDeleteUserRoleMvo();
        }
