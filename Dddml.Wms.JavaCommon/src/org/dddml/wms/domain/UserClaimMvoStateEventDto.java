...
public class UserClaimMvoStateEventDto extends AbstractStateEventDto
{
	...
	public static class UserClaimMvoStateCreatedDto extends UserClaimMvoStateEventDto
	{
        @Override
        public String getStateEventType()
        {
	...
	public static class UserClaimMvoStateMergePatchedDto extends UserClaimMvoStateEventDto
	{
        @Override
        public String getStateEventType()
        {
	...
	public class UserClaimMvoStateDeletedDto extends UserClaimMvoStateEventDto
	{
        @Override
        public String getStateEventType()
        {
