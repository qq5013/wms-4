...
public abstract class AbstractPermissionStateCommandConverter<TCreatePermission extends PermissionCommand.CreatePermission, TMergePatchPermission extends PermissionCommand.MergePatchPermission, TDeletePermission extends PermissionCommand.DeletePermission>
{
    ...
    public static class SimplePermissionStateCommandConverter extends AbstractPermissionStateCommandConverter<AbstractPermissionCommand.SimpleCreatePermission, AbstractPermissionCommand.SimpleMergePatchPermission, AbstractPermissionCommand.SimpleDeletePermission>
    {
        @Override
        protected AbstractPermissionCommand.SimpleCreatePermission newCreatePermission() {
            return new AbstractPermissionCommand.SimpleCreatePermission();
        }

        @Override
        protected AbstractPermissionCommand.SimpleMergePatchPermission newMergePatchPermission() {
            return new AbstractPermissionCommand.SimpleMergePatchPermission();
        }

        @Override
        protected AbstractPermissionCommand.SimpleDeletePermission newDeletePermission() {
            return new AbstractPermissionCommand.SimpleDeletePermission();
        }
