...
class MonthPlanIdFlattenedDto implements FlattenedDtoInterface
{
    ...
    /**
     * @param MonthPlanId $value
     */
    public function __construct(MonthPlanId $value = null)
    {
        if ($value) {
            $this->value = $value;
        } else {
            $this->value = new MonthPlanId();
        }
    }
     ...
     * @param string $data
     *
     * @return MonthPlanIdFlattenedDto
     */
