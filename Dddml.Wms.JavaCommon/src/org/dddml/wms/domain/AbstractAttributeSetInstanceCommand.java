...
public abstract class AbstractAttributeSetInstanceCommand extends AbstractCommand implements AttributeSetInstanceCommand
{
    ...
    public static abstract class AbstractMergePatchAttributeSetInstance extends AbstractCreateOrMergePatchAttributeSetInstance implements MergePatchAttributeSetInstance
    {
        @Override
        public String getCommandType() {
    ...
    public static class SimpleMergePatchAttributeSetInstance extends AbstractMergePatchAttributeSetInstance
    {
    }

	public static class SimpleDeleteAttributeSetInstance extends AbstractAttributeSetInstanceCommand implements DeleteAttributeSetInstance
	{
        @Override
        public String getCommandType() {
