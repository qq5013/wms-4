...
namespace Dddml.Wms.HttpServices.ApiControllers
{
    ...
    [RoutePrefix("api/AttributeSets")][Authorize]
    public partial class AttributeSetsController : ApiController
    {
        ...
        public IEnumerable<AttributeSetStateDto> GetAll(string sort = null, string fields = null, int firstResult = 0, int maxResults = int.MaxValue, string filter = null)
        {
          try {
            ...
            {
                states = _attributeSetApplicationService.Get(CriterionDto.ToSubclass(JObject.Parse(filter).ToObject<CriterionDto>(),new ApiControllerTypeConverter(), new PropertyTypeResolver())
        ...
        private class PropertyTypeResolver : IPropertyTypeResolver
        {
            ...
            {
                return AttributeSetsControllerUtils.GetFilterPropertyType(propertyName);
            }
        }
    ...
    public static class AttributeSetsControllerUtils
    {
        ...
        public static void SetNullIdOrThrowOnInconsistentIds(string id, CreateOrMergePatchOrDeleteAttributeSetDto value)
        {
            var idObj = id;
            ...
            else if (!((ICreateOrMergePatchOrDeleteAttributeSet)value).AttributeSetId.Equals(idObj))
            {
