...
public class HibernateRoleStateRepository implements RoleStateRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(RoleState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<RoleState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(RoleState.class);
    ...
    {
        List<RoleState> list = (List<RoleState>)get(filter, orders, 0, 1);
