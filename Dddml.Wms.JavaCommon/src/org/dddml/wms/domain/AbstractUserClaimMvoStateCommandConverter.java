...
public abstract class AbstractUserClaimMvoStateCommandConverter<TCreateUserClaimMvo extends UserClaimMvoCommand.CreateUserClaimMvo, TMergePatchUserClaimMvo extends UserClaimMvoCommand.MergePatchUserClaimMvo, TDeleteUserClaimMvo extends UserClaimMvoCommand.DeleteUserClaimMvo>
{
    ...
    public static class SimpleUserClaimMvoStateCommandConverter extends AbstractUserClaimMvoStateCommandConverter<AbstractUserClaimMvoCommand.SimpleCreateUserClaimMvo, AbstractUserClaimMvoCommand.SimpleMergePatchUserClaimMvo, AbstractUserClaimMvoCommand.SimpleDeleteUserClaimMvo>
    {
        @Override
        protected AbstractUserClaimMvoCommand.SimpleCreateUserClaimMvo newCreateUserClaimMvo() {
            return new AbstractUserClaimMvoCommand.SimpleCreateUserClaimMvo();
        }

        @Override
        protected AbstractUserClaimMvoCommand.SimpleMergePatchUserClaimMvo newMergePatchUserClaimMvo() {
            return new AbstractUserClaimMvoCommand.SimpleMergePatchUserClaimMvo();
        }

        @Override
        protected AbstractUserClaimMvoCommand.SimpleDeleteUserClaimMvo newDeleteUserClaimMvo() {
            return new AbstractUserClaimMvoCommand.SimpleDeleteUserClaimMvo();
        }
