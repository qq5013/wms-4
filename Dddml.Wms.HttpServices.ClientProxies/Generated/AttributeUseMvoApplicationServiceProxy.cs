...
namespace Dddml.Wms.HttpServices.ClientProxies
{
    ...
    public partial class AttributeUseMvoApplicationServiceProxy : IAttributeUseMvoApplicationService
    {
        ...
        {
            var idObj = ToIdString((c as ICreateAttributeUseMvo).AttributeSetAttributeUseId);
        ...
        {
            var idObj = ToIdString((c as IMergePatchAttributeUseMvo).AttributeSetAttributeUseId);
            var uriParameters = new AttributeUseMvoUriParameters();
            uriParameters.Id = idObj;
        ...
        public void When(DeleteAttributeUseMvoDto c)
        {
            //Action act = async () =>
            //{
            var idObj = ToIdString((c as IDeleteAttributeUseMvo).AttributeSetAttributeUseId);
            var uriParameters = new AttributeUseMvoUriParameters();
            uriParameters.Id = idObj;
        ...
        public IAttributeUseMvoState Get(AttributeSetAttributeUseId attributeSetAttributeUseId)
        {
            ...
            var idObj = ToIdString(attributeSetAttributeUseId);
            var uriParameters = new AttributeUseMvoUriParameters();
            uriParameters.Id = idObj;
        ...
        public IEnumerable<IAttributeUseMvoState> Get(IEnumerable<KeyValuePair<string, object>> filter, IList<string> orders = null, int firstResult = 0, int maxResults = int.MaxValue, IList<string> fields = null)
        {
			...
			var q = new AttributeUseMvoesGetQuery();
            ...
            var req = new AttributeUseMvoesGetRequest();
            req.Query = q;
            var resp = _ramlClient.AttributeUseMvoes.Get(req).GetAwaiter().GetResult();
            ThrowOnHttpResponseError(resp);
            states = resp.Content;
            return states;
        }
		...
		{
			var q = new AttributeUseMvoesCountGetQuery();
            q.FilterTag = GetFilterTagQueryValueString(filter);
            var req = new AttributeUseMvoesCountGetRequest();
            req.Query = q;
            var resp = _ramlClient.AttributeUseMvoesCount.Get(req).GetAwaiter().GetResult();
            ThrowOnHttpResponseError(resp);
        ...
        protected static string ToIdString(AttributeSetAttributeUseId id)
        {
