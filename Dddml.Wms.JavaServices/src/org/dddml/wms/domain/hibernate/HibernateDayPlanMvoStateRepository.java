...
public class HibernateDayPlanMvoStateRepository implements DayPlanMvoStateRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(AbstractDayPlanMvoState.SimpleDayPlanMvoState.class);
    ...
    public void save(DayPlanMvoState state)
    {
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(DayPlanMvoState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<DayPlanMvoState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(DayPlanMvoState.class);
    ...
    @Transactional(readOnly = true)
    public DayPlanMvoState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<DayPlanMvoState> list = (List<DayPlanMvoState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public DayPlanMvoState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
