...
namespace Dddml.Wms.Domain.NHibernate
{
	...
	public partial class NHibernateYearPlanMvoStateRepository : IYearPlanMvoStateRepository
	{
		...
		public NHibernateYearPlanMvoStateRepository ()
		{
		}

		[Transaction (ReadOnly = true)]
		public IYearPlanMvoState Get (YearPlanId id)
		{
			IYearPlanMvoState state = CurrentSession.Get<YearPlanMvoState> (id);
			if (state == null) {
				state = new YearPlanMvoState ();
				(state as YearPlanMvoState).YearPlanId = id;
			}
			return state;
		}
        ...
        {
            var criteria = CurrentSession.CreateCriteria<YearPlanMvoState>();
            criteria.SetFirstResult(firstResult);
            criteria.SetMaxResults(maxResults);
            AddNotDeletedRestriction(criteria);
            return criteria.List<YearPlanMvoState>();
        }

		[Transaction]
		public void Save (IYearPlanMvoState state)
		{
        ...
        [Transaction(ReadOnly = true)]
        public virtual IEnumerable<IYearPlanMvoState> Get(Dddml.Support.Criterion.ICriterion filter, IList<string> orders = null, int firstResult = 0, int maxResults = int.MaxValue)
        {
            var criteria = CurrentSession.CreateCriteria<YearPlanMvoState>();
        ...
        [Transaction(ReadOnly = true)]
        public virtual IYearPlanMvoState GetFirst(IEnumerable<KeyValuePair<string, object>> filter, IList<string> orders = null)
        {
            var list = (IList<YearPlanMvoState>)Get(filter, orders, 0, 1);
        ...
        [Transaction(ReadOnly = true)]
        public virtual IYearPlanMvoState GetFirst(KeyValuePair<string, object> keyValue, IList<string> orders = null)
        {
