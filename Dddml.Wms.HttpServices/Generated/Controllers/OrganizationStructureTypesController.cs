...
namespace Dddml.Wms.HttpServices.ApiControllers
{
    ...
    public partial class OrganizationStructureTypesController : ApiController
    {
        ...
        [Route(Order = 1)]
        [HttpGet]
        public IEnumerable<OrganizationStructureTypeStateDto> GetAll(string sort = null, string fields = null, int firstResult = 0, int maxResults = int.MaxValue, string filter = null)
        {
          try {
            ...
            {
                states = _organizationStructureTypeApplicationService.Get(GetQueryFilterDictionary(this.Request.GetQueryNameValuePairs())
                    , GetQueryOrders(sort), firstResult, maxResults);
            }
        ...
        [HttpGet]
        public OrganizationStructureTypeStateDto Get(string id, string fields = null)
        {
          try {
            var idObj = id;
        ...
        public long GetCount(string filter = null)
        {
          try
          {
            ...
            {
                count = _organizationStructureTypeApplicationService.GetCount(GetQueryFilterDictionary(this.Request.GetQueryNameValuePairs()));
            }
            return count;
          } catch (Exception ex) { var response = GetErrorHttpResponseMessage(ex); throw new HttpResponseException(response); }
        }
        ...
        protected static void SetNullIdOrThrowOnInconsistentIds(string id, CreateOrMergePatchOrDeleteOrganizationStructureTypeDto value)
        {
            var idObj = id;
            if (value.Id == null)
            {
