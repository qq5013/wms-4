...
class InOutLineMvo extends BaseEntity
{
     ...
     * @Type("string")
     */
    private $inOutDocumentStatus;

    /**
     * @return string
     */
    public function getInOutDocumentStatus()
    {
        return $this->inOutDocumentStatus;
    }

    /**
     * @var string $inOutDocumentStatus
     */
    public function setInOutDocumentStatus($inOutDocumentStatus)
    {
    ...
    /**
     * @var _UNKNOWN_ $inOutFreightAmount
     */
    ...
    /**
     * @var _UNKNOWN_ $inOutChargeAmount
     */
