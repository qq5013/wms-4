...
namespace Dddml.Wms.Domain.NHibernate
{
	...
	public class UserLoginMvoApplicationService : UserLoginMvoApplicationServiceBase
	{
		...
		public UserLoginMvoApplicationService(IEventStore eventStore, IUserLoginMvoStateRepository stateRepository)
		{
			this._eventStore = eventStore;
			this._stateRepository = stateRepository;
		}

		public override IEventStoreAggregateId ToEventStoreAaggregateId(UserLoginId aggregateId)
		{
