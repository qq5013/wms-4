...
public abstract class AbstractUserPermissionStateCommandConverter<TCreateUserPermission extends UserPermissionCommand.CreateUserPermission, TMergePatchUserPermission extends UserPermissionCommand.MergePatchUserPermission, TRemoveUserPermission extends UserPermissionCommand.RemoveUserPermission>
{
    ...
    public static class SimpleUserPermissionStateCommandConverter extends AbstractUserPermissionStateCommandConverter<AbstractUserPermissionCommand.SimpleCreateUserPermission, AbstractUserPermissionCommand.SimpleMergePatchUserPermission, AbstractUserPermissionCommand.SimpleRemoveUserPermission>
    {
        @Override
        protected AbstractUserPermissionCommand.SimpleCreateUserPermission newCreateUserPermission() {
            return new AbstractUserPermissionCommand.SimpleCreateUserPermission();
        }

        @Override
        protected AbstractUserPermissionCommand.SimpleMergePatchUserPermission newMergePatchUserPermission() {
            return new AbstractUserPermissionCommand.SimpleMergePatchUserPermission();
        }

        @Override
        protected AbstractUserPermissionCommand.SimpleRemoveUserPermission newRemoveUserPermission() {
            return new AbstractUserPermissionCommand.SimpleRemoveUserPermission();
        }
