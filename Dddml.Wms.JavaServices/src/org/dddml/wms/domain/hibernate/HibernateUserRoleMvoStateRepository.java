...
public class HibernateUserRoleMvoStateRepository implements UserRoleMvoStateRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(UserRoleMvoState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<UserRoleMvoState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(UserRoleMvoState.class);
    ...
    {
        List<UserRoleMvoState> list = (List<UserRoleMvoState>)get(filter, orders, 0, 1);
