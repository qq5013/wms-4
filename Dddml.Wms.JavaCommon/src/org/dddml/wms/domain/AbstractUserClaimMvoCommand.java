...
public abstract class AbstractUserClaimMvoCommand extends AbstractCommand implements UserClaimMvoCommand
{
    ...
    public static abstract class AbstractCreateOrMergePatchUserClaimMvo extends AbstractUserClaimMvoCommand implements CreateOrMergePatchUserClaimMvo
    {
    ...
    public static abstract class AbstractCreateUserClaimMvo extends AbstractCreateOrMergePatchUserClaimMvo implements CreateUserClaimMvo
    {
        @Override
    ...
    public static abstract class AbstractMergePatchUserClaimMvo extends AbstractCreateOrMergePatchUserClaimMvo implements MergePatchUserClaimMvo
    {
        @Override
        public String getCommandType() {
    ...
    public static class SimpleCreateUserClaimMvo extends AbstractCreateUserClaimMvo
    {
    }

    public static class SimpleMergePatchUserClaimMvo extends AbstractMergePatchUserClaimMvo
    {
    }

	public static class SimpleDeleteUserClaimMvo extends AbstractUserClaimMvoCommand implements DeleteUserClaimMvo
	{
        @Override
        public String getCommandType() {
