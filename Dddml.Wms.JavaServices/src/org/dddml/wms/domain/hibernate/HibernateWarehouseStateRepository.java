...
public class HibernateWarehouseStateRepository implements WarehouseStateRepository
{
    ...
    @Transactional(readOnly = true)
    public Iterable<WarehouseState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(WarehouseState.class);
    ...
    {
        List<WarehouseState> list = (List<WarehouseState>)get(filter, orders, 0, 1);
