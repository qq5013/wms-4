...
namespace Dddml.Wms.Domain
{
	...
	public class UserPermissionStateEventIdFlattenedDto : IIdFlattenedDto
	{

        private static string[] _flattenedPropertyNames = new string[] { "UserId", "PermissionId", "UserVersion" };
		...
		public UserPermissionStateEventIdFlattenedDto(UserPermissionStateEventId val)
		{
			this._value = val;
		}
		...
		public override bool Equals (object obj)
		{
			...
			UserPermissionStateEventIdFlattenedDto other = obj as UserPermissionStateEventIdFlattenedDto;
			if (other == null) {
				return false;
			}
