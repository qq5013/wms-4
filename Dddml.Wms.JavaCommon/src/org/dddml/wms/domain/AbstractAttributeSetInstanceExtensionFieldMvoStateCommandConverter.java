...
public abstract class AbstractAttributeSetInstanceExtensionFieldMvoStateCommandConverter<TCreateAttributeSetInstanceExtensionFieldMvo extends AttributeSetInstanceExtensionFieldMvoCommand.CreateAttributeSetInstanceExtensionFieldMvo, TMergePatchAttributeSetInstanceExtensionFieldMvo extends AttributeSetInstanceExtensionFieldMvoCommand.MergePatchAttributeSetInstanceExtensionFieldMvo, TDeleteAttributeSetInstanceExtensionFieldMvo extends AttributeSetInstanceExtensionFieldMvoCommand.DeleteAttributeSetInstanceExtensionFieldMvo>
{
    ...
    public static class SimpleAttributeSetInstanceExtensionFieldMvoStateCommandConverter extends AbstractAttributeSetInstanceExtensionFieldMvoStateCommandConverter<AbstractAttributeSetInstanceExtensionFieldMvoCommand.SimpleCreateAttributeSetInstanceExtensionFieldMvo, AbstractAttributeSetInstanceExtensionFieldMvoCommand.SimpleMergePatchAttributeSetInstanceExtensionFieldMvo, AbstractAttributeSetInstanceExtensionFieldMvoCommand.SimpleDeleteAttributeSetInstanceExtensionFieldMvo>
    {
        @Override
        protected AbstractAttributeSetInstanceExtensionFieldMvoCommand.SimpleCreateAttributeSetInstanceExtensionFieldMvo newCreateAttributeSetInstanceExtensionFieldMvo() {
            return new AbstractAttributeSetInstanceExtensionFieldMvoCommand.SimpleCreateAttributeSetInstanceExtensionFieldMvo();
        }

        @Override
        protected AbstractAttributeSetInstanceExtensionFieldMvoCommand.SimpleMergePatchAttributeSetInstanceExtensionFieldMvo newMergePatchAttributeSetInstanceExtensionFieldMvo() {
            return new AbstractAttributeSetInstanceExtensionFieldMvoCommand.SimpleMergePatchAttributeSetInstanceExtensionFieldMvo();
        }

        @Override
        protected AbstractAttributeSetInstanceExtensionFieldMvoCommand.SimpleDeleteAttributeSetInstanceExtensionFieldMvo newDeleteAttributeSetInstanceExtensionFieldMvo() {
            return new AbstractAttributeSetInstanceExtensionFieldMvoCommand.SimpleDeleteAttributeSetInstanceExtensionFieldMvo();
        }
