...
namespace Dddml.Wms.HttpServices.ClientProxies
{
    ...
    public partial class AttributeValueMvoApplicationServiceProxy : IAttributeValueMvoApplicationService
    {
        ...
        {
            var idObj = ToIdString((c as ICreateAttributeValueMvo).AttributeValueId);
        ...
        {
            var idObj = ToIdString((c as IMergePatchAttributeValueMvo).AttributeValueId);
            var uriParameters = new AttributeValueMvoUriParameters();
            uriParameters.Id = idObj;
        ...
        public void When(DeleteAttributeValueMvoDto c)
        {
            //Action act = async () =>
            //{
            var idObj = ToIdString((c as IDeleteAttributeValueMvo).AttributeValueId);
            var uriParameters = new AttributeValueMvoUriParameters();
            uriParameters.Id = idObj;
        ...
        public IAttributeValueMvoState Get(AttributeValueId attributeValueId)
        {
            ...
            var idObj = ToIdString(attributeValueId);
            var uriParameters = new AttributeValueMvoUriParameters();
            uriParameters.Id = idObj;
        ...
        protected static string ToIdString(AttributeValueId id)
        {
