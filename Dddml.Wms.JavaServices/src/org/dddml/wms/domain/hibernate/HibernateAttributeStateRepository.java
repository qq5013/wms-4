...
/*
        ...
        [Transaction(ReadOnly = true)]
        public virtual IEnumerable<IAttributeState> Get(Dddml.Support.Criterion.ICriterion filter, IList<string> orders = null, int firstResult = 0, int maxResults = int.MaxValue)
        {
            var criteria = CurrentSession.CreateCriteria<AttributeState>();
