...
public interface UserClaimMvoStateEvent extends Event
{

    UserClaimMvoStateEventId getStateEventId();
    ...
    interface UserClaimMvoStateMergePatched extends UserClaimMvoStateEvent
    {
    ...
    interface UserClaimMvoStateDeleted extends UserClaimMvoStateEvent
    {
    }
