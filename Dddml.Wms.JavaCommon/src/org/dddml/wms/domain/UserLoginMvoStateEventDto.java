...
public class UserLoginMvoStateEventDto extends AbstractStateEventDto
{
	...
	public static class UserLoginMvoStateCreatedDto extends UserLoginMvoStateEventDto
	{
        @Override
        public String getStateEventType()
        {
	...
	public static class UserLoginMvoStateMergePatchedDto extends UserLoginMvoStateEventDto
	{
        @Override
        public String getStateEventType()
        {
