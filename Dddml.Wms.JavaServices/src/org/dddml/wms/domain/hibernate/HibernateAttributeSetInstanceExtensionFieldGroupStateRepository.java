...
public class HibernateAttributeSetInstanceExtensionFieldGroupStateRepository implements AttributeSetInstanceExtensionFieldGroupStateRepository
{
    ...
    @Transactional(readOnly = true)
    public Iterable<AttributeSetInstanceExtensionFieldGroupState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(AttributeSetInstanceExtensionFieldGroupState.class);
    ...
    @Transactional(readOnly = true)
    public AttributeSetInstanceExtensionFieldGroupState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<AttributeSetInstanceExtensionFieldGroupState> list = (List<AttributeSetInstanceExtensionFieldGroupState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public AttributeSetInstanceExtensionFieldGroupState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
