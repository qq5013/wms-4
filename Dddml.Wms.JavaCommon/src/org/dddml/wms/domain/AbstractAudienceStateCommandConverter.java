...
public abstract class AbstractAudienceStateCommandConverter<TCreateAudience extends AudienceCommand.CreateAudience, TMergePatchAudience extends AudienceCommand.MergePatchAudience, TDeleteAudience extends AudienceCommand.DeleteAudience>
{
    ...
    public static class SimpleAudienceStateCommandConverter extends AbstractAudienceStateCommandConverter<AbstractAudienceCommand.SimpleCreateAudience, AbstractAudienceCommand.SimpleMergePatchAudience, AbstractAudienceCommand.SimpleDeleteAudience>
    {
        @Override
        protected AbstractAudienceCommand.SimpleCreateAudience newCreateAudience() {
            return new AbstractAudienceCommand.SimpleCreateAudience();
        }

        @Override
        protected AbstractAudienceCommand.SimpleMergePatchAudience newMergePatchAudience() {
            return new AbstractAudienceCommand.SimpleMergePatchAudience();
        }

        @Override
        protected AbstractAudienceCommand.SimpleDeleteAudience newDeleteAudience() {
            return new AbstractAudienceCommand.SimpleDeleteAudience();
        }
