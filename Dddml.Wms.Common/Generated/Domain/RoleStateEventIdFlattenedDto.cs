...
namespace Dddml.Wms.Domain
{
	...
	public class RoleStateEventIdFlattenedDto : IIdFlattenedDto
	{

        private static string[] _flattenedPropertyNames = new string[] { "RoleId", "Version" };
		...
		public override bool Equals (object obj)
		{
			...
			RoleStateEventIdFlattenedDto other = obj as RoleStateEventIdFlattenedDto;
			if (other == null) {
				return false;
			}
