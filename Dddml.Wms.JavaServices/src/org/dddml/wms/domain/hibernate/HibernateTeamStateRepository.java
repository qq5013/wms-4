...
public class HibernateTeamStateRepository implements TeamStateRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(AbstractTeamState.SimpleTeamState.class);
    ...
    public void save(TeamState state)
    {
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(TeamState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<TeamState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(TeamState.class);
    ...
    @Transactional(readOnly = true)
    public TeamState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<TeamState> list = (List<TeamState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public TeamState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
