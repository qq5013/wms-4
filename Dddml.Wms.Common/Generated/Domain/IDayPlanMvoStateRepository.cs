...
{
	public partial interface IDayPlanMvoStateRepository
	{
        IDayPlanMvoState Get(DayPlanId id);

        IEnumerable<IDayPlanMvoState> GetAll(int firstResult, int maxResults);
        
        void Save(IDayPlanMvoState state);
        ...
        IDayPlanMvoState GetFirst(IEnumerable<KeyValuePair<string, object>> filter, IList<string> orders = null);

        IDayPlanMvoState GetFirst(KeyValuePair<string, object> keyValue, IList<string> orders = null);
