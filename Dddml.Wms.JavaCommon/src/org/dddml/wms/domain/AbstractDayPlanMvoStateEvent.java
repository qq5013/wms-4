...
public abstract class AbstractDayPlanMvoStateEvent extends AbstractStateEvent implements DayPlanMvoStateEvent 
{
    private DayPlanMvoStateEventId stateEventId;

    public DayPlanMvoStateEventId getStateEventId() {
        return this.stateEventId;
    }

    public void setStateEventId(DayPlanMvoStateEventId stateEventId) {
    ...
    protected AbstractDayPlanMvoStateEvent() {
    }

    protected AbstractDayPlanMvoStateEvent(DayPlanMvoStateEventId stateEventId) {
        this.stateEventId = stateEventId;
    }
    ...
    public static abstract class AbstractDayPlanMvoStateCreated extends AbstractDayPlanMvoStateEvent implements DayPlanMvoStateCreated
    {
        public AbstractDayPlanMvoStateCreated() {
        }

        public AbstractDayPlanMvoStateCreated(DayPlanMvoStateEventId stateEventId) {
            super(stateEventId);
        }
    ...
    public static abstract class AbstractDayPlanMvoStateMergePatched extends AbstractDayPlanMvoStateEvent implements DayPlanMvoStateMergePatched
    {
        public AbstractDayPlanMvoStateMergePatched() {
        }

        public AbstractDayPlanMvoStateMergePatched(DayPlanMvoStateEventId stateEventId) {
            super(stateEventId);
        }
    ...
    public static abstract class AbstractDayPlanMvoStateDeleted extends AbstractDayPlanMvoStateEvent implements DayPlanMvoStateDeleted
    {
        public AbstractDayPlanMvoStateDeleted() {
        }

        public AbstractDayPlanMvoStateDeleted(DayPlanMvoStateEventId stateEventId) {
            super(stateEventId);
        }
        ...
        public static class SimpleDayPlanMvoStateCreated extends AbstractDayPlanMvoStateCreated
        {
			public SimpleDayPlanMvoStateCreated() {
			}

			public SimpleDayPlanMvoStateCreated(DayPlanMvoStateEventId stateEventId) {
				super(stateEventId);
			}
        }

        public static class SimpleDayPlanMvoStateMergePatched extends AbstractDayPlanMvoStateMergePatched
        {
			public SimpleDayPlanMvoStateMergePatched() {
			}

			public SimpleDayPlanMvoStateMergePatched(DayPlanMvoStateEventId stateEventId) {
				super(stateEventId);
			}
        }

        public static class SimpleDayPlanMvoStateDeleted extends AbstractDayPlanMvoStateDeleted
        {
			public SimpleDayPlanMvoStateDeleted() {
			}

			public SimpleDayPlanMvoStateDeleted(DayPlanMvoStateEventId stateEventId) {
				super(stateEventId);
			}
        }
