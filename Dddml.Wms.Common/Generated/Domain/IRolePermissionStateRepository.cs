...
{
	public partial interface IRolePermissionStateRepository
	{
        ...
        IRolePermissionState GetFirst(IEnumerable<KeyValuePair<string, object>> filter, IList<string> orders = null);

        IRolePermissionState GetFirst(KeyValuePair<string, object> keyValue, IList<string> orders = null);
