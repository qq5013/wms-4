...
namespace Dddml.Wms.Domain.NHibernate
{
    ...
    public partial class NHibernateLocatorTreeRepository : ILocatorTreeRepository
    {
        ...
        public IEnumerable<ILocatorTree> GetRoots(Dddml.Support.Criterion.ICriterion filter, int firstResult = 0, int maxResults = int.MaxValue)
        {
            var states = LocatorStateRepository.GetLocatorTreeRoots(filter, firstResult, maxResults);
            return ToLocatorTreeCollection(states);
        }

        public IEnumerable<ILocatorTree> GetChildren(string parentId, Dddml.Support.Criterion.ICriterion filter, int firstResult = 0, int maxResults = int.MaxValue)
        {
