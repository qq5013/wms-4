...
public class HibernateAttributeSetInstanceExtensionFieldMvoStateRepository implements AttributeSetInstanceExtensionFieldMvoStateRepository
{
    ...
    @Transactional(readOnly = true)
    public Iterable<AttributeSetInstanceExtensionFieldMvoState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(AttributeSetInstanceExtensionFieldMvoState.class);
    ...
    @Transactional(readOnly = true)
    public AttributeSetInstanceExtensionFieldMvoState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<AttributeSetInstanceExtensionFieldMvoState> list = (List<AttributeSetInstanceExtensionFieldMvoState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public AttributeSetInstanceExtensionFieldMvoState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
