...
public class HibernateAttributeValueMvoStateRepository implements AttributeValueMvoStateRepository
{
    ...
    @Transactional(readOnly = true)
    public Iterable<AttributeValueMvoState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(AttributeValueMvoState.class);
    ...
    {
        List<AttributeValueMvoState> list = (List<AttributeValueMvoState>)get(filter, orders, 0, 1);
