...
public abstract class AbstractRoleStateCommandConverter<TCreateRole extends RoleCommand.CreateRole, TMergePatchRole extends RoleCommand.MergePatchRole, TDeleteRole extends RoleCommand.DeleteRole>
{
    ...
    public static class SimpleRoleStateCommandConverter extends AbstractRoleStateCommandConverter<AbstractRoleCommand.SimpleCreateRole, AbstractRoleCommand.SimpleMergePatchRole, AbstractRoleCommand.SimpleDeleteRole>
    {
        @Override
        protected AbstractRoleCommand.SimpleCreateRole newCreateRole() {
            return new AbstractRoleCommand.SimpleCreateRole();
        }

        @Override
        protected AbstractRoleCommand.SimpleMergePatchRole newMergePatchRole() {
            return new AbstractRoleCommand.SimpleMergePatchRole();
        }

        @Override
        protected AbstractRoleCommand.SimpleDeleteRole newDeleteRole() {
            return new AbstractRoleCommand.SimpleDeleteRole();
        }
