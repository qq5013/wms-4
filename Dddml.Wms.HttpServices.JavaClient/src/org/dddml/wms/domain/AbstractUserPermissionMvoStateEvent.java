...
public abstract class AbstractUserPermissionMvoStateEvent implements UserPermissionMvoStateEvent
{
    ...
    public UserPermissionMvoStateEventId getStateEventId() {
        return this.stateEventId;
    }

    public void setStateEventId(UserPermissionMvoStateEventId stateEventId) {
    ...
    protected AbstractUserPermissionMvoStateEvent(UserPermissionMvoStateEventId stateEventId) {
        this.stateEventId = stateEventId;
    }
    ...
    public static abstract class AbstractUserPermissionMvoStateCreated extends AbstractUserPermissionMvoStateEvent implements UserPermissionMvoStateCreated
    {
        public AbstractUserPermissionMvoStateCreated() {
        }

        public AbstractUserPermissionMvoStateCreated(UserPermissionMvoStateEventId stateEventId) {
            super(stateEventId);
        }
    ...
    {
        public AbstractUserPermissionMvoStateDeleted() {
        }

        public AbstractUserPermissionMvoStateDeleted(UserPermissionMvoStateEventId stateEventId) {
            super(stateEventId);
        }
