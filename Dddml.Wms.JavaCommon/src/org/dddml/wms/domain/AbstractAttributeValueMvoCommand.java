...
public abstract class AbstractAttributeValueMvoCommand extends AbstractCommand implements AttributeValueMvoCommand
{
    ...
    public static abstract class AbstractCreateAttributeValueMvo extends AbstractCreateOrMergePatchAttributeValueMvo implements CreateAttributeValueMvo
    {
        @Override
    ...
    public static abstract class AbstractMergePatchAttributeValueMvo extends AbstractCreateOrMergePatchAttributeValueMvo implements MergePatchAttributeValueMvo
    {
        @Override
        public String getCommandType() {
    ...
    public static class SimpleCreateAttributeValueMvo extends AbstractCreateAttributeValueMvo
    {
    }
