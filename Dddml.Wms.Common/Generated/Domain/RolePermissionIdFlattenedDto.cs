...
namespace Dddml.Wms.Domain
{
	...
	public class RolePermissionIdFlattenedDto : IIdFlattenedDto
	{

        private static string[] _flattenedPropertyNames = new string[] { "RoleId", "PermissionId" };
		...
		public override bool Equals (object obj)
		{
			...
			RolePermissionIdFlattenedDto other = obj as RolePermissionIdFlattenedDto;
			if (other == null) {
				return false;
			}
